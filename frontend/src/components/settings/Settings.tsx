  ...
  return (
    <div className="h-full flex flex-col p-8 bg-gray-50 items-center flex-grow">
      <div className="flex flex-col space-y-8 w-11/12 lg:w-fit">
        <div className="w-full flex flex-col space-y-8 lg:grid lg:grid-cols-3 lg:gap-x-4 lg:space-y-0">
          {/*Projects*/}
          <div className="w-full flex flex-col space-y-4">
            <div className="text-xl font-bold">Projects</div>
            <div className="w-full flex flex-col max-h-64 space-y-4 overflow-y-auto items-start bg-white shadow-md p-8 rounded-md">
