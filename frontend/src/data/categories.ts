...
export const categories = [
  ...
  { category: "Apartments", costCode: "62-1003-TRV" },
  { category: "Car Rental", costCode: "62-1004-TRV" },
  { category: "Client Entertainment", costCode: "62-1006-TRV" },
  { category: "Company Events", costCode: "62-1007-TRV" },
  { category: "Hotel", costCode: "62-1002-TRV" },
  { category: "Job Site Material", costCode: "01-7200-MAT" },
  { category: "Mileage", costCode: "62-1009-TRV" },
  { category: "Parking", costCode: "62-1010-TRV" },
  { category: "Per Diem", costCode: "62-1005-TRV" },
  { category: "Reimbursable Gas", costCode: "62-1011-TRV" },
  { category: "Relocation", costCode: "62-1008-TRV" },
  { category: "Tolls", costCode: "62-1009-TRV" },
  { category: "Wellness", costCode: "64-6161-OVH" },
